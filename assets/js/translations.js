window.PORTFOLIO_TRANSLATIONS = {
  ru: {
    meta_title: "Max Tall - Веб-дизайнер | Лендинги, редизайн и UI Kit",
    meta_description:
      "Портфолио веб-дизайнера Max Tall: лендинги, редизайн сайтов, UI Kit и дизайн-процессы для бизнеса и стартапов.",
    meta_og_title: "Max Tall - Веб-дизайнер",
    meta_og_description:
      "Лендинг-портфолио веб-дизайнера. Проекты, услуги, процесс и быстрый контакт в Telegram.",
    meta_og_locale: "ru_RU",
    ...
    hero_mockup_label: "live preview",
    ...
    step_2_title: "Дизайн",
    step_2_text: "Создание визуальной концепции, ключевых экранов и компонентов.",
    step_3_title: "Проектирование",
    step_3_text: "Финализация интерфейса, адаптивов и подготовка к разработке.",

    principles_label: "Наш дизайн строится на нескольких принципах",
    principles_title: "Каждое решение поддерживает задачу бизнеса",
    principle_1_title: "Удобство",
    principle_1_text: "Пользователь быстро понимает структуру и следующий шаг.",
    principle_2_title: "Акцент на важном",
    principle_2_text: "Визуальная иерархия направляет внимание на целевые действия.",
    principle_3_title: "Грамотный дизайн",
    principle_3_text: "Система отступов, типографика и компоненты работают как единое целое.",
    principle_4_title: "Без лишнего",
    ...
    contact_question: "Решили заказать дизайн, или остались вопросы?",
    contact_link: "Связаться",
    channel_title: "Авторский канал о веб-дизайне",
  ...
  en: {
    meta_title: "Max Tall - Web Designer | Landing Pages, Redesign and UI Kit",
    meta_description:
      "Portfolio of web designer Max Tall: landing pages, website redesign, UI kits and design processes for brands and startups.",
    meta_og_title: "Max Tall - Web Designer",
    meta_og_description:
      "One-page portfolio website: projects, services, process and direct Telegram contact.",
    ...
    step_2_title: "Design",
    step_2_text: "Visual concept, key screens and component architecture.",
    step_3_title: "Planning",
    step_3_text: "Final responsive system and handoff-ready design package.",

    principles_label: "Our design is built on core principles",
    principles_title: "Each decision supports business objectives",
    principle_1_title: "Usability",
    principle_1_text: "Users quickly understand structure and next actions.",
    principle_2_title: "Focus",
    principle_2_text: "Visual hierarchy directs attention to key interactions.",
    principle_3_title: "Design Logic",
    principle_3_text: "Spacing, typography and components act as one coherent system.",
    principle_4_title: "No Noise",
    ...
    contact_question: "Ready to order a design, or still have questions?",
    contact_link: "Contact",
    channel_title: "Author's web design channel",
